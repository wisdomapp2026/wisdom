  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="px-6 mt-6 flex flex-col items-center">
        ...
        <h1 className="text-xl font-bold text-gray-900 mt-3 text-center">Milliy sertifikat kursi</h1>
        <p className="text-sm text-gray-500 text-center mt-1">
          O'z bilimingizni tasdiqlang va yangi<br/>cho'qqilarni zabt eting.
        </p>
        ...
        <div className="w-full bg-primary-500 rounded-2xl py-5 text-center mt-6">
          ...
          <p className="text-white text-3xl font-bold mt-1">
            50 000 so'm <span className="text-base font-normal">/ oy</span>
          </p>
        </div>
        ...
        <Link
          to="/payment"
          className="w-full bg-primary-500 text-white font-bold py-4 rounded-xl text-center flex items-center justify-center gap-2 mt-2"
        >
          Obuna bo'lish <span>›</span>
        </Link>

        <Link to="/" className="text-sm text-gray-500 mt-4">Keyinroq davom etish</Link>

        <p className="text-[10px] text-gray-400 text-center mt-6 mb-8">
