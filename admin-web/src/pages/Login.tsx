        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 border border-gray-200 rounded-xl py-3 bg-white hover:bg-gray-50 active:scale-[0.98] transition-all"
            >
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-xs text-gray-400">yoki email bilan</span>
              <div className="flex-1 h-px bg-gray-200" />
            </div>
            <div>
